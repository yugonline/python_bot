...
# client = vision.Client(project='LinkGrabber', credentials=cred)
# image = client.image(source_uri='gs://linkgrabber_images/demo-image.jpg')
...
def detect_text(path):
    ...
    myString = texts[0].description
    # print myString
    text = re.findall(URL_REGEX, myString)
    if(len(text) > 1):
    	return text
    else:
    	return text[0]
